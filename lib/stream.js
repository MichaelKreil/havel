...
module.exports = Havel => {
	...
	Havel.registerNodeFactoryStream('readFile', (filename, opt = {}) => {
		...
		if (opt.showProgress) {
			...
			stream.on('end', () => {
				if (opt.showProgress) process.stderr.write('\n')
			});
		}
	...
	Havel.registerNodeFactoryStream('writeFile', (filename) => {
